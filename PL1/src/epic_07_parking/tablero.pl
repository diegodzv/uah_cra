% =========================
% tablero.pl
% Epica 7: tablero, banco, jugadores y partida con caja de parking
% =========================
...
crear_banco_inicial(banco(0, Propiedades, 32, 12, 0)) :-
    tablero(Tablero),
    findall(
...
% partida(
%   Tablero, Banco, Jugadores, TurnoActual, MaxTurnos,
%   EstadoDados, PoliticaCompra, PoliticaCarcel, Historial
% )
crear_partida_inicial(
    NombresJugadores,
    DineroInicial,
    MaxTurnos,
    Etiqueta,
