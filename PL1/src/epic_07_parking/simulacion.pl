% =========================
% simulacion.pl
% Epica 7: simulacion con compras, alquileres, impuestos, parking, carcel y bancarrota
% =========================
...
simular_turno(
    ...
    Banco0 = banco(_, _, _, _, CajaParkingInicial),
    ...
    (
        PerdidoPorCarcel == si ->
            ...
            CajaParkingFinal = CajaParkingInicial,
    ...
    ;
        ...
        BancoFinal = banco(_, _, _, _, CajaParkingFinal)
    ),

    jugador_final_o_placeholder(
        JugadoresFinal,
        NombreJugador,
        PosNueva,
        DineroInicialTurno,
