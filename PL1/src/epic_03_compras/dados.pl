% =========================
% dados.pl
% Epica 3: pseudoaleatoriedad reproducible de dados
% =========================
...
extraer_siguiente(estado_dados(Semilla, Base, []), Valor, EstadoSiguiente) :-
    extraer_siguiente(estado_dados(Semilla, Base, Base), Valor, EstadoSiguiente).

extraer_siguiente(estado_dados(Semilla, Base, [X|Resto]), X, estado_dados(Semilla, Base, Resto)).
