% =========================
% tablero.pl
% Epica 4: tablero, banco, jugadores y partida
% =========================
...
crear_jugador_inicial(Nombre, DineroInicial, jugador(Nombre, 1, DineroInicial, [], no)).
...
% partida(Tablero, Banco, Jugadores, TurnoActual, MaxTurnos, EstadoDados, PoliticaCompra, Historial)
crear_partida_inicial(NombresJugadores, DineroInicial, MaxTurnos, Etiqueta, EstadoDados, PoliticaCompra,
    partida(Tablero, Banco, Jugadores, 1, MaxTurnos, EstadoDados, PoliticaCompra, historial(Etiqueta, []))) :-
    tablero(Tablero),
