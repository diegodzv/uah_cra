% =========================
% tablero.pl
% Epica 2: representacion del tablero y del estado
% =========================
...
%   Historial
% )
crear_partida_inicial(NombresJugadores, MaxTurnos, Etiqueta, EstadoDados, partida(Tablero, Banco, Jugadores, 1, MaxTurnos, EstadoDados, historial(Etiqueta, []))) :-
    tablero(Tablero),
